...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Work Schedule') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('work_schedule.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" name="lunch_start_time" id="lunch_start_time" class="form-control  @error('lunch_start_time') is-invalid @enderror" value="{{ old('lunch_start_time') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" name="lunch_end_time" id="lunch_end_time" class="form-control @error('lunch_end_time') is-invalid @enderror" value="{{ old('lunch_end_time') }}">
